...
$(OBJ_PATH)/Game_Velha.o: $(SRC_PATH)/Velha.cpp $(INC_PATH)/Velha.hpp
	$(CXX) $(CXXFLAGS) -c $(SRC_PATH)/Velha.cpp -o $(OBJ_PATH)/Game_Velha.o -I$(INC_PATH)
...
$(OBJ_PATH)/Game_Liga4.o: $(SRC_PATH)/Liga4.cpp $(INC_PATH)/Liga4.hpp
	$(CXX) $(CXXFLAGS) -c $(SRC_PATH)/Liga4.cpp -o $(OBJ_PATH)/Game_Liga4.o -I$(INC_PATH)
